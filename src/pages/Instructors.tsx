...
function displayTeacher(teacher: string, search: string) {
    if (teacher.toLowerCase().includes(search.toLowerCase()) || search === '')
        return true;
    return false;
}
